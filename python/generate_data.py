...
OUTPUT_PATH = "C:/Projects/finance-analytics-platform/data/raw"

customers_df.to_csv(f"{OUTPUT_PATH}/customers.csv", index=False)
markets_df.to_csv(f"{OUTPUT_PATH}/markets.csv", index=False)
crm_df.to_csv(f"{OUTPUT_PATH}/crm_revenue.csv", index=False)
billing_df.to_csv(f"{OUTPUT_PATH}/billing_revenue.csv", index=False)
gl_df.to_csv(f"{OUTPUT_PATH}/gl_revenue.csv", index=False)
churn_df.to_csv(f"{OUTPUT_PATH}/churn_events.csv", index=False)
